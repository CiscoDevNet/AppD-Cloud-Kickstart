...
mv ./env-configmap.yaml /home/ec2-user/AppD-Cloud-Kickstart/applications/AD-Capital-Kube/Kubernetes/env-configmap.yaml
...
mv ./secret.yaml /home/ec2-user/AppD-Cloud-Kickstart/applications/AD-Capital-Kube/Kubernetes/secret.yaml
