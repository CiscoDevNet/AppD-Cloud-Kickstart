...
appd_aws_eks_version="${appd_aws_eks_version:-1.31}"
...
Usage:
  ...
  [OPTIONAL] eksctl command parameters [w/ defaults].
    ...
    [centos]$ export appd_aws_eks_version="1.31"                                # [optional] kubernetes version (defaults to '1.31').
                                                                                #            valid versions:
                                                                                #              '1.29, 1.30, 1.31, and '1.32'
