...
You will need to use an existing AMI image named **APM-Platform-23110-CentOS79-AMI** and located in the AWS region that you are working in:
...
Once you have identified the appropriate AMI, launch an instance of it via:
  ...
  1. Select the **APM-Platform-23110-CentOS79-AMI** and click the **Launch** button.
...
<serverstatus vendorid="" version="1">
  ...
  <serverinfo>
    ...
    <serverversion>023-011-000-001</serverversion>
    <implementationVersion>Controller v23.11.0.1 Build 23.11.0-10089 Commit 8743cbd56244fe5ba520994c6626d6a39bc96e66</implementationVersion>
  </serverinfo>
