...
You will need to use an existing AMI image named **APM-Platform-2142-CentOS79-AMI** and located in the AWS region that you are working in:
...
Once you have identified the appropriate AMI, launch an instance of it via:
  ...
  1. Select the **APM-Platform-2142-CentOS79-AMI** and click the **Launch** button.
...
<serverstatus vendorid="" version="1">
  ...
  <serverinfo>
    ...
    <serverversion>021-004-002-000</serverversion>
    <implementationVersion>Controller v21.4.2.0 Build 21.4.2-1268 Commit 694c23527c4969a70c1ff90a0ccda2f40e77b7f6</implementationVersion>
  </serverinfo>
