...
You will need to use an existing AMI image named **APM-Platform-21412-CentOS79-AMI** and located in the AWS region that you are working in:
...
Once you have identified the appropriate AMI, launch an instance of it via:
  ...
  1. Select the **APM-Platform-21412-CentOS79-AMI** and click the **Launch** button.
...
<serverstatus vendorid="" version="1">
  ...
  <serverinfo>
    ...
    <serverversion>021-004-012-000</serverversion>
    <implementationVersion>Controller v21.4.12.0 Build 21.4.12-1500 Commit 2b232a07d61b716e89e3c959e6fcde7745b7bfa6</implementationVersion>
  </serverinfo>
