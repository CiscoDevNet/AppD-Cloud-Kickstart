...
You will need to use an existing AMI image named **APM-Platform-21413-CentOS79-AMI** and located in the AWS region that you are working in:
...
Once you have identified the appropriate AMI, launch an instance of it via:
  ...
  1. Select the **APM-Platform-21413-CentOS79-AMI** and click the **Launch** button.
...
<serverstatus vendorid="" version="1">
  ...
  <serverinfo>
    ...
    <serverversion>021-004-013-000</serverversion>
    <implementationVersion>Controller v21.4.13.0 Build 21.4.13-1511 Commit ecf851adf727fbbdcec964ef930aa346e7e91fb0</implementationVersion>
  </serverinfo>
