...
You will need to use an existing AMI image named **APM-Platform-21420-CentOS79-AMI** and located in the AWS region that you are working in:
...
Once you have identified the appropriate AMI, launch an instance of it via:
  ...
  1. Select the **APM-Platform-21420-CentOS79-AMI** and click the **Launch** button.
...
<serverstatus vendorid="" version="1">
  ...
  <serverinfo>
    ...
    <serverversion>021-004-020-000</serverversion>
    <implementationVersion>Controller v21.4.20.0 Build 21.4.20-1696 Commit dfbc3cc44ab9e7160a7906bb805cb9bc2d1ee617</implementationVersion>
  </serverinfo>
