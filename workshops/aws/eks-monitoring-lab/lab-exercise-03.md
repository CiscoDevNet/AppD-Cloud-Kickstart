...
You will need to use an existing AMI image named **APM-Platform-21410-CentOS79-AMI** and located in the AWS region that you are working in:
...
Once you have identified the appropriate AMI, launch an instance of it via:
  ...
  1. Select the **APM-Platform-21410-CentOS79-AMI** and click the **Launch** button.
...
<serverstatus vendorid="" version="1">
  ...
  <serverinfo>
    ...
    <serverversion>021-004-010-000</serverversion>
    <implementationVersion>Controller v21.4.10.0 Build 21.4.10-1472 Commit 77df446a158dbeed25802e1db3ae5096bbe6a876</implementationVersion>
  </serverinfo>
