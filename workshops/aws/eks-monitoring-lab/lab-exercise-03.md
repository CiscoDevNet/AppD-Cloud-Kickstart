...
You will need to use an existing AMI image named **APM-Platform-21411-CentOS79-AMI** and located in the AWS region that you are working in:
...
Once you have identified the appropriate AMI, launch an instance of it via:
  ...
  1. Select the **APM-Platform-21411-CentOS79-AMI** and click the **Launch** button.
...
<serverstatus vendorid="" version="1">
  ...
  <serverinfo>
    ...
    <serverversion>021-004-011-000</serverversion>
    <implementationVersion>Controller v21.4.11.0 Build 21.4.11-1492 Commit f6139e365138b6274f07fadf5111a8288044326a</implementationVersion>
  </serverinfo>
