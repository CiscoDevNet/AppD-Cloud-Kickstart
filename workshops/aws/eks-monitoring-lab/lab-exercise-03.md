...
You will need to use an existing AMI image named **APM-Platform-2148-CentOS79-AMI** and located in the AWS region that you are working in:
...
Once you have identified the appropriate AMI, launch an instance of it via:
  ...
  1. Select the **APM-Platform-2148-CentOS79-AMI** and click the **Launch** button.
...
<serverstatus vendorid="" version="1">
  ...
  <serverinfo>
    ...
    <serverversion>021-004-008-000</serverversion>
    <implementationVersion>Controller v21.4.8.0 Build 21.4.8-1411 Commit b033c0b81ed6bee007189ab505608d236a164fdc</implementationVersion>
  </serverinfo>
