...
You will need to use an existing AMI image named **APM-Platform-21419-CentOS79-AMI** and located in the AWS region that you are working in:
...
Once you have identified the appropriate AMI, launch an instance of it via:
  ...
  1. Select the **APM-Platform-21419-CentOS79-AMI** and click the **Launch** button.
...
<serverstatus vendorid="" version="1">
  ...
  <serverinfo>
    ...
    <serverversion>021-004-019-000</serverversion>
    <implementationVersion>Controller v21.4.19.0 Build 21.4.19-1681 Commit b77ed97baa94c29ec51c9ec4f3655bb10deb7387</implementationVersion>
  </serverinfo>
