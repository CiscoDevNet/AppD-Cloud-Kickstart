...
You will need to use an existing AMI image named **APM-Platform-4517-CentOS77-AMI** and located in the AWS region that you are working in:
...
Once you have identified the appropriate AMI, launch an instance of it via:
  ...
  1. Select the **APM-Platform-4517-CentOS77-AMI** and click the **Launch** button.
