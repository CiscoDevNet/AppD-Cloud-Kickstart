...
You will need to use an existing AMI image named **APM-Platform-2146-CentOS79-AMI** and located in the AWS region that you are working in:
...
Once you have identified the appropriate AMI, launch an instance of it via:
  ...
  1. Select the **APM-Platform-2146-CentOS79-AMI** and click the **Launch** button.
...
<serverstatus vendorid="" version="1">
  ...
  <serverinfo>
    ...
    <serverversion>021-004-006-000</serverversion>
    <implementationVersion>Controller v21.4.6.0 Build 21.4.6-1382 Commit d1793b65786f3d3e410f4550d387d5cb3f72cab7</implementationVersion>
  </serverinfo>
