...
You will need to use an existing AMI image named **APM-Platform-2420-CentOS79-AMI** and located in the AWS region that you are working in:
...
Once you have identified the appropriate AMI, launch an instance of it via:
  ...
  1. Select the **APM-Platform-2420-CentOS79-AMI** and click the **Launch** button.
...
<serverstatus vendorid="" version="1">
  ...
  <serverinfo>
    ...
    <serverversion>024-002-000-001</serverversion>
    <implementationVersion>Controller v24.2.0.1 Build 24.2.0-10039 Commit dc1d4576ab133dedeccf09ef81ff361b00b61b2e</implementationVersion>
  </serverinfo>
