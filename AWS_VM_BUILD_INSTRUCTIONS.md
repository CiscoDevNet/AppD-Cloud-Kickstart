...
-	Amazon AWS CLI 1.16.232 (command-line interface)
-	Python 3.7.4
	-	Pip 19.2.3
...
3.	Install [AWS CLI 1.16.232](https://docs.aws.amazon.com/cli/latest/userguide/install-macos.html#awscli-install-osx-pip).  
...
5.	Validate installed command-line tools:
    ...
    $ aws --version
    aws-cli/1.16.232 Python/3.7.4 Darwin/18.7.0 botocore/1.12.222
    ```
...
1.	Install [AWS CLI 1.16.232](https://s3.amazonaws.com/aws-cli/AWSCLI64PY3.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```
    $ aws --version
    aws-cli/1.16.232 Python/3.6.0 Windows/10 botocore/1.12.222
    ```
...
-	Amazon AWS CLI 1.16.232 (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.5.1 (command-line interface)
