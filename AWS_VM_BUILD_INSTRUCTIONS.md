...
-	Amazon AWS CLI 1.16.283 (command-line interface)
-	Python 3.7.5
	-	Pip 19.3.1
...
3.	Install [AWS CLI 1.16.283](https://docs.aws.amazon.com/cli/latest/userguide/install-macos.html#awscli-install-osx-pip).  
...
5.	Validate installed command-line tools:
    ...
    $ aws --version
    aws-cli/1.16.283 Python/3.7.5 Darwin/18.7.0 botocore/1.13.19
    ```
...
1.	Install [AWS CLI 1.16.283](https://s3.amazonaws.com/aws-cli/AWSCLI64PY3.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```
    $ aws --version
    aws-cli/1.16.283 Python/3.6.0 Windows/10 botocore/1.13.19
    ```
