...
-	Amazon AWS CLI 1.16.230 (command-line interface)
-	Python 3.7.4
	-	Pip 19.2.3
...
3.	Install [AWS CLI 1.16.230](https://docs.aws.amazon.com/cli/latest/userguide/install-macos.html#awscli-install-osx-pip).  
...
1.	Install [AWS CLI 1.16.230](https://s3.amazonaws.com/aws-cli/AWSCLI64PY3.msi) for Windows 64-bit.  
...
-	AppDynamics Enterprise Console 4.5.13.0 Build 20658
...
-	Amazon AWS CLI 1.16.230 (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.4.3 (command-line interface)
-	Amazon AWS IAM Authenticator 1.13.8 for AWS EKS CLI and kubectl.
-	Amazon AWS Kubernetes Control CLI [kubectl] 1.13.8 (command-line interface)
-	Docker 19.03.1 CE
	-	Docker Bash Completion
	-	Docker Compose 1.24.1
	-	Docker Compose Bash Completion
