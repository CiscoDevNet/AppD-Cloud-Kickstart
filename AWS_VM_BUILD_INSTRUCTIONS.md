...
-	Amazon AWS CLI 1.17.7 (command-line interface)
-	Python 3.7.6
	-	Pip 20.0.1
...
2.	Upgrade [Pip 20.0.1](https://pypi.org/project/pip/) for macOS 64-bit.  
    `$ pip3 install pip --upgrade --user`  

3.	Install [AWS CLI 1.17.7](https://docs.aws.amazon.com/cli/latest/userguide/install-macos.html#awscli-install-osx-pip).  
...
5.	Validate installed command-line tools:
    ...
    $ pip3 --version
    pip 20.0.1 from /usr/local/lib/python3.7/site-packages/pip (python 3.7)

    $ aws --version
    aws-cli/1.17.7 Python/3.7.6 Darwin/18.7.0 botocore/1.14.7
    ```
...
1.	Install [AWS CLI 1.17.7](https://s3.amazonaws.com/aws-cli/AWSCLI64PY3.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```
    $ aws --version
    aws-cli/1.17.7 Python/3.6.0 Windows/10 botocore/1.14.7
    ```
...
-	npm JavaScript Package Manager for Node.js 6.13.6
