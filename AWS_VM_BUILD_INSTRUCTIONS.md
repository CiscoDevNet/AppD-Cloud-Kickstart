...
-	Amazon AWS CLI 1.16.184 (command-line interface)
-	Python 3.7.3
	-	Pip 19.1.1
...
3.	Install [AWS CLI 1.16.184](https://docs.aws.amazon.com/cli/latest/userguide/install-macos.html#awscli-install-osx-pip).  
...
1.	Install [AWS CLI 1.16.184](https://s3.amazonaws.com/aws-cli/AWSCLI64PY3.msi) for Windows 64-bit.  
...
-	Amazon AWS CLI 1.16.184 (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.1.38 (command-line interface)
