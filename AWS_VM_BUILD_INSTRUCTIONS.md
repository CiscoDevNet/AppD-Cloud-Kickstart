...
-	Amazon AWS CLI 1.16.240 (command-line interface)
-	Python 3.7.4
	-	Pip 19.2.3
...
2.	Upgrade [Pip 19.2.3](https://pypi.org/project/pip/) for macOS 64-bit.  
    `$ pip3 install --upgrade pip`  

3.	Install [AWS CLI 1.16.240](https://docs.aws.amazon.com/cli/latest/userguide/install-macos.html#awscli-install-osx-pip).  
...
5.	Validate installed command-line tools:
    ...
    $ aws --version
    aws-cli/1.16.240 Python/3.7.4 Darwin/18.7.0 botocore/1.12.230
    ```
...
1.	Install [AWS CLI 1.16.240](https://s3.amazonaws.com/aws-cli/AWSCLI64PY3.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```
    $ aws --version
    aws-cli/1.16.240 Python/3.6.0 Windows/10 botocore/1.12.230
    ```
...
1.	Build the __APM-Platform VM__ CentOS 7.6 AMI image:
    ...
    $ packer build apm-platform-centos76.json
    ```
...
2.	Build the __CWOM-Platform VM__ CentOS 7.6 AMI image:
    ...
    ```
    $ cd /<drive>/projects/AppD-Cloud-Kickstart/builders/packer/aws
    $ packer build cwom-platform-centos76.json
    ```
...
3.	Build the __LPAD-EKS VM__ CentOS 7.6 AMI image:
    ...
    ```
    $ packer build lpad-eks-centos76.json
    ```
...
-	AppDynamics Enterprise Console 4.5.13.0 Build 20661
	-	AppDynamics Controller 4.5.13.1 Build 3075
...
-	Amazon AWS CLI 1.16.240 (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.5.3 (command-line interface)
