...
-	Amazon AWS CLI 1.18.16 (command-line interface)
-	Python 3.7.6
	-	Pip 20.0.2
...
3.	Install [AWS CLI 1.18.16](https://docs.aws.amazon.com/cli/latest/userguide/install-macos.html#awscli-install-osx-pip).  
...
5.	Validate installed command-line tools:
    ...
    $ aws --version
    aws-cli/1.18.16 Python/3.7.6 Darwin/18.7.0 botocore/1.15.16
    ```
...
1.	Install [AWS CLI 1.18.16](https://s3.amazonaws.com/aws-cli/AWSCLI64PY3.msi) for Windows 64-bit.  
...
-	Cisco Workload Optimization Manager (CWOM) 2.3.9
-	Docker 19.03.7 CE
	-	Docker Bash Completion
	-	Docker Compose 1.25.4
	-	Docker Compose Bash Completion
...
-	Python 3.6.3
	-	Pip 20.0.2
-	Serverless Framework CLI 1.66.0
-	VIM - Vi IMproved 8.2
