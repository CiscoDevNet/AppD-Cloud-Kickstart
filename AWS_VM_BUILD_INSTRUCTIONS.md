...
-	Amazon AWS CLI 1.17.2 (command-line interface)
-	Python 3.7.6
	-	Pip 19.3.1
...
3.	Install [AWS CLI 1.17.2](https://docs.aws.amazon.com/cli/latest/userguide/install-macos.html#awscli-install-osx-pip).  
...
5.	Validate installed command-line tools:
    ...
    $ aws --version
    aws-cli/1.17.2 Python/3.7.6 Darwin/18.7.0 botocore/1.14.2
    ```
...
1.	Install [AWS CLI 1.17.2](https://s3.amazonaws.com/aws-cli/AWSCLI64PY3.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```
    $ aws --version
    aws-cli/1.17.2 Python/3.6.0 Windows/10 botocore/1.14.2
    ```
...
-	Python 3.6.3
	-	Pip 19.3.1
-	Serverless Framework CLI 1.61.1
