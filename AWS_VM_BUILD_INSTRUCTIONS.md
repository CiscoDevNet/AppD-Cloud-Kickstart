...
-	Amazon AWS CLI 1.16.194 (command-line interface)
-	Python 3.7.3
	-	Pip 19.1.1
...
3.	Install [AWS CLI 1.16.194](https://docs.aws.amazon.com/cli/latest/userguide/install-macos.html#awscli-install-osx-pip).  
...
5.	Validate installed command-line tools:
    ...
    $ aws --version
    aws-cli/1.16.194 Python/3.7.3 Darwin/18.6.0 botocore/1.12.184
    ```
...
1.	Install [AWS CLI 1.16.194](https://s3.amazonaws.com/aws-cli/AWSCLI64PY3.msi) for Windows 64-bit.  
...
-	Amazon AWS CLI 1.16.194 (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.1.39 (command-line interface)
