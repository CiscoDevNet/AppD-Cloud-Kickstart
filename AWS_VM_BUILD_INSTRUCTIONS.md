...
-	Amazon AWS CLI 1.16.223 (command-line interface)
-	Python 3.7.4
	-	Pip 19.2.2
...
2.	Upgrade [Pip 19.2.2](https://pypi.org/project/pip/) for macOS 64-bit.  
    `$ pip3 install --upgrade pip`  

3.	Install [AWS CLI 1.16.223](https://docs.aws.amazon.com/cli/latest/userguide/install-macos.html#awscli-install-osx-pip).  
...
5.	Validate installed command-line tools:
    ...
    $ aws --version
    aws-cli/1.16.223 Python/3.7.4 Darwin/18.7.0 botocore/1.12.213
    ```
...
1.	Install [AWS CLI 1.16.223](https://s3.amazonaws.com/aws-cli/AWSCLI64PY3.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```
    $ aws --version
    aws-cli/1.16.223 Python/3.6.0 Windows/10 botocore/1.12.213
    ```
...
-	Amazon AWS CLI 1.16.223 (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.4.2 (command-line interface)
