...
-	Amazon AWS CLI 1.16.255 (command-line interface)
-	Python 3.7.4
	-	Pip 19.2.3
...
3.	Install [AWS CLI 1.16.255](https://docs.aws.amazon.com/cli/latest/userguide/install-macos.html#awscli-install-osx-pip).  
...
1.	Install [AWS CLI 1.16.255](https://s3.amazonaws.com/aws-cli/AWSCLI64PY3.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```
    $ aws --version
    aws-cli/1.16.255 Python/3.6.0 Windows/10 botocore/1.12.245
    ```
