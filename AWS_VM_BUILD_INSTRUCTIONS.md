...
3.	Install [AWS CLI 1.16.292](https://docs.aws.amazon.com/cli/latest/userguide/install-macos.html#awscli-install-osx-pip).  
...
5.	Validate installed command-line tools:
    ...
    $ aws --version
    aws-cli/1.16.292 Python/3.7.5 Darwin/18.7.0 botocore/1.13.28
    ```
...
1.	Install [AWS CLI 1.16.292](https://s3.amazonaws.com/aws-cli/AWSCLI64PY3.msi) for Windows 64-bit.  
