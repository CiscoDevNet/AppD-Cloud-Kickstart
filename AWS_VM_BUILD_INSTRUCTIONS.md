...
-	Amazon AWS CLI 1.18.22 (command-line interface)
-	Python 3.7.7
	-	Pip 20.0.2
...
3.	Install [AWS CLI 1.18.22](https://docs.aws.amazon.com/cli/latest/userguide/install-macos.html#awscli-install-osx-pip).  
...
5.	Validate installed command-line tools:
    ...
    $ aws --version
    aws-cli/1.18.22 Python/3.7.7 Darwin/18.7.0 botocore/1.15.22
    ```
...
1.	Install [AWS CLI 1.18.22](https://s3.amazonaws.com/aws-cli/AWSCLI64PY3.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```
    $ aws --version
    aws-cli/1.18.22 Python/3.6.0 Windows/10 botocore/1.15.22
    ```
...
-	AppDynamics Enterprise Console 20.3.0 Build 21871
	-	AppDynamics Controller v20.3.0.1 Build 20.3.0-3101
