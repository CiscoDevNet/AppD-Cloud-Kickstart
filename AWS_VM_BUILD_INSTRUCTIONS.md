...
-	Amazon AWS CLI 1.16.263 (command-line interface)
-	Python 3.7.4
	-	Pip 19.3.1
...
3.	Install [AWS CLI 1.16.263](https://docs.aws.amazon.com/cli/latest/userguide/install-macos.html#awscli-install-osx-pip).  
...
5.	Validate installed command-line tools:
    ...
    $ aws --version
    aws-cli/1.16.263 Python/3.7.4 Darwin/18.7.0 botocore/1.12.253
    ```
...
1.	Install [AWS CLI 1.16.263](https://s3.amazonaws.com/aws-cli/AWSCLI64PY3.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```
    $ aws --version
    aws-cli/1.16.263 Python/3.6.0 Windows/10 botocore/1.12.253
    ```
...
-	Helm CLI [helm/tiller] 2.15.0 (Package Manager for Kubernetes)
-	Java SE JDK 8 Update 232 (Amazon Corretto 8)
