...
-	Amazon AWS CLI 1.18.13 (command-line interface)
-	Python 3.7.6
	-	Pip 20.0.2
...
3.	Install [AWS CLI 1.18.13](https://docs.aws.amazon.com/cli/latest/userguide/install-macos.html#awscli-install-osx-pip).  
...
5.	Validate installed command-line tools:
    ...
    $ aws --version
    aws-cli/1.18.13 Python/3.7.6 Darwin/18.7.0 botocore/1.15.13
    ```
...
1.	Install [AWS CLI 1.18.13](https://s3.amazonaws.com/aws-cli/AWSCLI64PY3.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```
    $ aws --version
    aws-cli/1.18.13 Python/3.6.0 Windows/10 botocore/1.15.13
    ```
...
-	AppDynamics Enterprise Console 4.5.17.0 Build 21656
	-	AppDynamics Controller 4.5.17.1 Build 2807
...
-	Amazon AWS CLI 1.18.13 (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.14.0 (command-line interface)
...
-	AppDynamics Node.js Serverless Tracer 1.0.2
-	Docker 19.03.7 CE
	-	Docker Bash Completion
	-	Docker Compose 1.25.4
	-	Docker Compose Bash Completion
