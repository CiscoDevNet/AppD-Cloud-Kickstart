...
-	Amazon AWS CLI 2.0.27 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.0.27](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```
    $ aws --version
    aws-cli/2.0.27 Python/3.8.3 Darwin/19.5.0 botocore/2.0.0dev31
    ```
...
1.	Install [AWS CLI 2.0.27](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```
    $ aws --version
    aws-cli/2.0.27 Python/3.7.7 Windows/10 botocore/2.0.0dev31
    ```
...
-	AppDynamics Enterprise Console 20.6.3 Build 22636
	-	AppDynamics Controller 20.6.3 Build 2318
...
-	Amazon AWS EC2 Instance Metadata Query Tool (command-line interface)
-	Ansible 2.9.9
-	Cisco Workload Optimization Manager (CWOM) 2.3.17
-	Docker 19.03.12 CE
	-	Docker Bash Completion
	-	Docker Compose 1.26.0
	-	Docker Compose Bash Completion
