...
output "teastore_vm_hostname_prefix" {
  description = "Azure TeaStore VM hostname prefix."
  value       = var.azurerm_teastore_vm_hostname_prefix
}
...
output "teastore_private_ips" {
  description = "The private IP addresses assigned to the TeaStore VM instances."
  value       = flatten([toset(azurerm_linux_virtual_machine.teastore.*.private_ip_address)])
}

output "teastore_public_ips" {
  description = "The public IP addresses assigned to the TeaStore VM instances."
  value       = flatten([toset(azurerm_linux_virtual_machine.teastore.*.public_ip_address)])
}
