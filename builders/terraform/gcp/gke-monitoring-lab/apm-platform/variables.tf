...
variable "gcp_apm_platform_vm_nat_ip" {
  description = "Public ip address for APM Platform VM instance."
  default     = null
}
...
variable "gcp_source_image_family" {
  ...
  type        = string
  default     = "apm-platform-centos79-images"
# default     = "centos-7"
}
...
variable "gcp_source_image" {
  ...
  type        = string
  default     = "apm-platform-centos79-2021-03-29"
...
variable "resource_labels" {
  ...
  default = {
    ...
    "event"   = "apm-platform-vm-deployment"
  }
}
