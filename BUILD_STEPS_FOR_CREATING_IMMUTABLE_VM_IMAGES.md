...
3.	Install [Packer 1.4.4](https://packer.io/) for macOS 64-bit.  
    `$ brew install packer`  
...
1.	Install [Packer 1.4.4](https://releases.hashicorp.com/packer/1.4.4/packer_1.4.4_windows_amd64.zip) for Windows 64-bit.  
