...
3.	Install [Packer 1.6.1](https://packer.io/) for macOS 64-bit.  
    `$ brew install packer`  
...
1.	Install [Packer 1.6.1](https://releases.hashicorp.com/packer/1.6.1/packer_1.6.1_windows_amd64.zip) for Windows 64-bit.  
