...
appd_platform_release="${appd_platform_release:-24.4.0.10054}"
appd_platform_sha256="${appd_platform_sha256:-a65f3a31b43ce27525e3075d97f801687d232e78c2737fcfb6b7cc951875ed4a}"
appd_platform_user_name="${appd_platform_user_name:-ubuntu}"
appd_platform_user_group="${appd_platform_user_group:-ubuntu}"
...
Usage:
  ...
  [OPTIONAL] appdynamics platform install parameters [w/ defaults].
    ...
    [root]# export appd_platform_release="24.4.0.10054"                 # [optional] platform release (defaults to '24.4.0.10054').
                                                                        # [optional] platform sha-256 checksum (defaults to published value).
    [root]# export appd_platform_sha256="a65f3a31b43ce27525e3075d97f801687d232e78c2737fcfb6b7cc951875ed4a"
    [root]# export appd_platform_user_name="ubuntu"                     # [optional] platform user name (defaults to 'ubuntu').
    [root]# export appd_platform_user_group="ubuntu"                    # [optional] platform group (defaults to 'ubuntu').
...
mkdir -p ${kickstart_home}/provisioners/scripts/ubuntu/appdynamics
cd ${kickstart_home}/provisioners/scripts/ubuntu/appdynamics
...
runuser -c "${kickstart_home}/provisioners/scripts/ubuntu/appdynamics/${appd_platform_installer} -q -varfile ${response_file}" - ${appd_platform_user_name}
