...
appd_project_image_types="${appd_project_image_types-APM-Platform-CentOS79 APM-Platform-Ubuntu-Jammy LPAD-CentOS79 LPAD-CentOS8-Stream LPAD-OracleLinux89 LPAD-Rocky89 LPAD-Ubuntu-Jammy TeaStore-CentOS79}"
