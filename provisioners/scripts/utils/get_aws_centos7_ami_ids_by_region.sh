...
# get current date.
curdate=$(date +"%d %b %Y")
echo "# CentOS 7.6 AMI Image IDs as of: ${curdate}."
...
# CentOS 7.6 AMI Image IDs as of: 02 May 2019.
#aws_ami_source="ami-033e6106180a626d0"     # CentOS 7.6 AMI (HVM), SSD Volume Type: ca-central-1 [Central]
#aws_ami_source="ami-04cf43aca3e6f3de3"     # CentOS 7.6 AMI (HVM), SSD Volume Type: eu-central-1 [Frankfurt]
#aws_ami_source="ami-0ff760d16d9497662"     # CentOS 7.6 AMI (HVM), SSD Volume Type: eu-west-1 [Ireland]
#aws_ami_source="ami-0eab3a90fc693af19"     # CentOS 7.6 AMI (HVM), SSD Volume Type: eu-west-2 [London]
#aws_ami_source="ami-0e1ab783dc9489f34"     # CentOS 7.6 AMI (HVM), SSD Volume Type: eu-west-3 [Paris]
#aws_ami_source="ami-02eac2c0129f6376b"     # CentOS 7.6 AMI (HVM), SSD Volume Type: us-east-1 [N. Virginia]
#aws_ami_source="ami-0f2b4fc905b0bd1f1"     # CentOS 7.6 AMI (HVM), SSD Volume Type: us-east-2 [Ohio]
#aws_ami_source="ami-074e2d6769f445be5"     # CentOS 7.6 AMI (HVM), SSD Volume Type: us-west-1 [N. California]
#aws_ami_source="ami-01ed306a12b7d1c96"     # CentOS 7.6 AMI (HVM), SSD Volume Type: us-west-2 [Oregon]
