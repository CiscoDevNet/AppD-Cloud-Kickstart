...
echo "--------------------------------------"
echo "AWS Providers:"
curl --silent https://api.github.com/repos/hashicorp/terraform-provider-aws/releases/latest | jq '. | {tag_name: .tag_name, html_url: .html_url}'
...
curl --silent https://api.github.com/repos/terraform-aws-modules/terraform-aws-eks/releases/latest | jq '. | {tag_name: .tag_name, html_url: .html_url}'
...
curl --silent https://api.github.com/repos/hashicorp/terraform/releases/latest | jq '. | {tag_name: .tag_name, html_url: .html_url}'
