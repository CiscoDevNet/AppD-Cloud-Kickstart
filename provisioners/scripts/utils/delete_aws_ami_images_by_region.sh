...
appd_project_image_types="${appd_project_image_types-APM-Platform-AL2 APM-Platform-CentOS7 CWOM-Platform-CentOS7 DEVNET-CentOS7 EXT-CentOS7 LPAD-AlmaLinux8 LPAD-AlmaLinux9 LPAD-AL2 LPAD-AL2023 LPAD-CentOS7 LPAD-CentOS8-Stream LPAD-CentOS9-Stream LPAD-Fedora34 LPAD-Rocky8 LPAD-Rocky9 LPAD-Ubuntu-Bionic LPAD-Ubuntu-Focal LPAD-Ubuntu-Jammy LPAD-Ubuntu-Kinetic LPAD-Ubuntu-Lunar K8S-CentOS7 PoV-Playbook1-AL2 PoV-Playbook1-CentOS7 PoV-Playbook1-Ubuntu-Bionic PoV-Playbook1-Ubuntu-Focal PoV-Playbook1-Ubuntu-Jammy TeaStore-CentOS7}"
