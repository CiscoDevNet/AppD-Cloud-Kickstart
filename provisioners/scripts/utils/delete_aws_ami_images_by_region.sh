...
appd_project_image_types="${appd_project_image_types-APM-Platform-CentOS APM-Platform-HA-CentOS CWOM-Platform-CentOS DEVNET-CentOS EXT-CentOS LPAD-AL2 LPAD-CentOS K8S-CentOS}"
