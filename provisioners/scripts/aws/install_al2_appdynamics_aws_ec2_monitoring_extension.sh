...
if [ "$appd_aws_ec2_extension_config" == "true" ]; then
  ...
  # add 'eu-west-2' and 'eu-west-3' as a region endpoints. (it is curently missing in release 2.1.1.)
  ...
  # add 'us-east-2' as a region endpoint. (it is curently missing in release 2.1.1.)
