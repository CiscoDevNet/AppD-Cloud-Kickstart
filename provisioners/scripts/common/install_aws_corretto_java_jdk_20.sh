#!/bin/sh -eux
#---------------------------------------------------------------------------------------------------
# Install Amazon Corretto 20 OpenJDK by Amazon.
#
...
# set amazon corretto 20 installation variables. ---------------------------------------------------
jdk_home="jdk20"
jdk_build="20.0.2.10.1"
jdk_sha256="3b60fe04966d0aa762bf1fc2974ad239cf7ab887a657a9e7e3c75a9310e34db2"
...
# download and validate corretto 20 binary from aws. -----------------------------------------------
# download the corretto 20 binary.
rm -f ${jdk_binary}
...
# download the corretto 20 pgp signature.
rm -f ${jdk_sig_file}
...
# import the corretto 20 public key.
...
# install amazon corretto 20. ----------------------------------------------------------------------
# remove existing installation.
rm -f ${jdk_home}
rm -Rf ${jdk_folder}

# extract corretto 20 binary and create softlink to 'jdk20'.
...
# set corretto 20 home environment variables.
