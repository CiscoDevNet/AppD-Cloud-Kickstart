...
appd_cluster_agent_release="${appd_cluster_agent_release:-21.5.0.2052}"
appd_cluster_agent_sha256="${appd_cluster_agent_sha256:-45a0006f47e7b56b8c3af60da381d58a84e76b666e6be822b1e448edc319ad27}"
...
Usage:
  ...
  [OPTIONAL] appdynamics cluster agent install parameters [w/ defaults].
    ...
    [root]# export appd_cluster_agent_release="21.5.0.2052"             # [optional] cluster agent release (defaults to '21.5.0.2052').
                                                                        # [optional] cluster agent sha-256 checksum (defaults to published value).
    [root]# export appd_cluster_agent_sha256="45a0006f47e7b56b8c3af60da381d58a84e76b666e6be822b1e448edc319ad27"
