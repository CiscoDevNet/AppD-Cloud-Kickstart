...
tomcat_release="${tomcat_release:-8.5.38}"                          # [optional] tomcat release (defaults to '8.5.38').
...
Usage:
  ...
  Example:
   # tomcat web server install parameters.
    ...
    [root]# export tomcat_release="8.5.38"                      # [optional] tomcat release (defaults to '8.5.38').
   #
