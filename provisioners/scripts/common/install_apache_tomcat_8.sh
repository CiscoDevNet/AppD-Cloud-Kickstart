...
tomcat_release="${tomcat_release:-8.5.37}"                          # [optional] tomcat release (defaults to '8.5.37').
...
Usage:
  ...
  Example:
   # tomcat web server install parameters.
    ...
    [root]# export tomcat_release="8.5.37"                      # [optional] tomcat release (defaults to '8.5.37').
   #
