#!/bin/sh -eux
#---------------------------------------------------------------------------------------------------
# Install Amazon Corretto 16 OpenJDK by Amazon.
#
...
# set amazon corretto 16 installation variables. ---------------------------------------------------
jdk_home="jdk16"
jdk_build="16.0.0.36.1"
jdk_checksum="d56849ca9f9bcf2c28f19ec1585579a9"
...
# download and validate corretto 16 binary from aws. -----------------------------------------------
# download the corretto 16 binary.
rm -f ${jdk_binary}
...
# download the corretto 16 pgp signature.
rm -f ${jdk_sig_file}
...
# import the corretto 16 public key.
...
# extract corretto 16 binary and create softlink to 'jdk16'.
...
# set corretto 16 home environment variables.
