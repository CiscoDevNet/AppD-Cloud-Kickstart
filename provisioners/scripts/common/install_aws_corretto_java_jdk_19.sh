#!/bin/sh -eux
#---------------------------------------------------------------------------------------------------
# Install Amazon Corretto 19 OpenJDK by Amazon.
#
...
jdk_home="jdk19"
jdk_build="19.0.0.36.1"
jdk_sha256="00f8ec4a9c7905a633213eacff45550900106ce695840b2a4c095c325e395faf"
...
# download and validate corretto 19 binary from aws. -----------------------------------------------
# download the corretto 19 binary.
rm -f ${jdk_binary}
...
# download the corretto 19 pgp signature.
rm -f ${jdk_sig_file}
...
# install amazon corretto 19. ----------------------------------------------------------------------
# remove existing installation.
rm -f ${jdk_home}
rm -Rf ${jdk_folder}

# extract corretto 19 binary and create softlink to 'jdk19'.
...
# set corretto 19 home environment variables.
