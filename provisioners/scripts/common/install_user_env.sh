...
d_completion_release="${d_completion_release:-20.10.6}"
dc_completion_release="${dc_completion_release:-1.29.1}"
...
Usage:
  ...
  Example:
    ...
    [root]# export user_prompt_color="yellow"                   # [optional] user prompt color (defaults to 'green').
                                                                ...
                                                                #
    [root]# export d_completion_release="20.10.6"               # [optional] docker completion for bash release (defaults to '20.10.6').
    [root]# export dc_completion_release="1.29.1"               # [optional] docker compose completion for bash release (defaults to '1.29.1').
