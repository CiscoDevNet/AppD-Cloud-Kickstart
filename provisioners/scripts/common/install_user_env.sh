...
d_completion_release="${d_completion_release:-19.03.14}"
...
Usage:
  ...
  Example:
    ...
    [root]# export user_prompt_color="yellow"                   # [optional] user prompt color (defaults to 'green').
                                                                ...
                                                                #
    [root]# export d_completion_release="19.03.14"              # [optional] docker completion for bash release (defaults to '19.03.14').
