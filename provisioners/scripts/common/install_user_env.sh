...
dc_completion_release="${dc_completion_release:-1.26.2}"
...
Usage:
  ...
  Example:
    ...
    [root]# export dc_completion_release="1.26.2"               # [optional] docker compose completion for bash release (defaults to '1.26.2').
