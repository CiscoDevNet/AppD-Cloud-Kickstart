...
d_completion_release="${d_completion_release:-27.0.3}"
...
Usage:
  ...
  Example:
    ...
    [root]# export user_prompt_color="yellow"                   # [optional] user prompt color (defaults to 'green').
                                                                ...
                                                                #
    [root]# export d_completion_release="27.0.3"                # [optional] docker completion for bash release (defaults to '27.0.3').
