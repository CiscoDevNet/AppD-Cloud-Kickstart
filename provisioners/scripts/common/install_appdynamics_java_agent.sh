...
appd_java_agent_release="${appd_java_agent_release:-20.8.0.30686}"
appd_java_agent_sha256="${appd_java_agent_sha256:-5112c2f598be0c75f794a264b3a218337a00bfa3ec2b8edb7da4a617547f0267}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="20.8.0.30686"               # [optional] java agent release (defaults to '20.8.0.30686').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="5112c2f598be0c75f794a264b3a218337a00bfa3ec2b8edb7da4a617547f0267"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver20.8.0.30686/conf/controller-info.xml'
