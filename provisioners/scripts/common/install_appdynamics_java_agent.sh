...
appd_java_agent_release="${appd_java_agent_release:-22.6.0.33917}"
appd_java_agent_sha256="${appd_java_agent_sha256:-25009768b0d1d94198a14d44b29fbb1c572912f75bdb565ca343fb2ad80befb4}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="22.6.0.33917"               # [optional] java agent release (defaults to '22.6.0.33917').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="25009768b0d1d94198a14d44b29fbb1c572912f75bdb565ca343fb2ad80befb4"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver22.6.0.33917/conf/controller-info.xml'
