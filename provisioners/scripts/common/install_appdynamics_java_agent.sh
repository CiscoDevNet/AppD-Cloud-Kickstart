...
appd_java_agent_release="${appd_java_agent_release:-23.5.0.34821}"
appd_java_agent_sha256="${appd_java_agent_sha256:-89748fbb92a93259b95a40bdf3bf9d33b235ffbc4ca1e26cb1fd3caa7da41e2a}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="23.5.0.34821"               # [optional] java agent release (defaults to '23.5.0.34821').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="89748fbb92a93259b95a40bdf3bf9d33b235ffbc4ca1e26cb1fd3caa7da41e2a"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver23.5.0.34821/conf/controller-info.xml'
