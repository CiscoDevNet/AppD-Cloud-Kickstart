...
appd_java_agent_release="${appd_java_agent_release:-21.9.0.33073}"
appd_java_agent_sha256="${appd_java_agent_sha256:-9a5921aa15430c34ef4f2495337118dbbe8d5495e570374d08ba5616654f969a}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="21.9.0.33073"               # [optional] java agent release (defaults to '21.9.0.33073').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="9a5921aa15430c34ef4f2495337118dbbe8d5495e570374d08ba5616654f969a"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver21.9.0.33073/conf/controller-info.xml'
