...
appd_java_agent_release="${appd_java_agent_release:-21.6.1.32843}"
appd_java_agent_sha256="${appd_java_agent_sha256:-43c830c3dfafdc1983cbbfe8b9c3e9f7bfa10889b361f0801fd7bb810fbd32d2}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="21.6.1.32843"               # [optional] java agent release (defaults to '21.6.1.32843').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="43c830c3dfafdc1983cbbfe8b9c3e9f7bfa10889b361f0801fd7bb810fbd32d2"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver21.6.1.32843/conf/controller-info.xml'
