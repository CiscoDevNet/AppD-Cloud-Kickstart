...
appd_java_agent_release="${appd_java_agent_release:-20.5.0.30113}"
appd_java_agent_sha256="${appd_java_agent_sha256:-4cc6f3e6604d6329aac2b0dc7333e91d9581eae6abfefe390812353f26cfe6e6}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="20.5.0.30113"               # [optional] java agent release (defaults to '20.5.0.30113').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="4cc6f3e6604d6329aac2b0dc7333e91d9581eae6abfefe390812353f26cfe6e6"
