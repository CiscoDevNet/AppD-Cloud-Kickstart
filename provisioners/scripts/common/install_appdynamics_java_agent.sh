...
appd_java_agent_release="${appd_java_agent_release:-24.4.1.35880}"
appd_java_agent_sha256="${appd_java_agent_sha256:-c573cb904c29215421f9d5029d4888cbf0c5e6e8c5aa6004b46120036f8bb417}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="24.4.1.35880"               # [optional] java agent release (defaults to '24.4.1.35880').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="c573cb904c29215421f9d5029d4888cbf0c5e6e8c5aa6004b46120036f8bb417"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver24.4.1.35880/conf/controller-info.xml'
