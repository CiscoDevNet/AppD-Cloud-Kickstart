...
appd_java_agent_release="${appd_java_agent_release:-21.11.0.33247}"
appd_java_agent_sha256="${appd_java_agent_sha256:-7043e56617a0639171d3bd1ddacf1c7c0748a4cdf4997d295f39642ff428b201}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="21.11.0.33247"               # [optional] java agent release (defaults to '21.11.0.33247').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="7043e56617a0639171d3bd1ddacf1c7c0748a4cdf4997d295f39642ff428b201"
