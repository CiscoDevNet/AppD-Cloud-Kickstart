...
appd_java_agent_sha256="${appd_java_agent_sha256:-7a813f8b7436deb077d299e11a7ad8bb84213fbe79ff70ba2244e363bfc2ab12}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="24.7.0.36185"               # [optional] java agent release (defaults to '24.7.0.36185').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="7a813f8b7436deb077d299e11a7ad8bb84213fbe79ff70ba2244e363bfc2ab12"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver24.7.0.36185/conf/controller-info.xml'
