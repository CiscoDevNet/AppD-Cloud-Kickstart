...
appd_java_agent_release="${appd_java_agent_release:-21.11.3.33314}"
appd_java_agent_sha256="${appd_java_agent_sha256:-b5e9474474ab5e73717b3e45b4a8ff66706016998bf80f6ca2b221e36aa44123}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="21.11.3.33314"               # [optional] java agent release (defaults to '21.11.3.33314').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="b5e9474474ab5e73717b3e45b4a8ff66706016998bf80f6ca2b221e36aa44123"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver21.11.3.33314/conf/controller-info.xml'
