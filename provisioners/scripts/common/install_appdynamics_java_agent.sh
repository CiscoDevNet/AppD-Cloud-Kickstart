...
appd_java_agent_release="${appd_java_agent_release:-22.3.0.33637}"
appd_java_agent_sha256="${appd_java_agent_sha256:-568aa98cd15e8da77d1c1b40d50feafbe251447b14f24844c79ac8fa48de4866}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="22.3.0.33637"               # [optional] java agent release (defaults to '22.3.0.33637').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="568aa98cd15e8da77d1c1b40d50feafbe251447b14f24844c79ac8fa48de4866"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver22.3.0.33637/conf/controller-info.xml'
