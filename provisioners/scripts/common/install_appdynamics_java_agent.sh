...
appd_java_agent_release="${appd_java_agent_release:-21.10.0.33144}"
appd_java_agent_sha256="${appd_java_agent_sha256:-6b7f3690890dbbc6148699710550333ce31dd19da6f41321baa0d6fc180b18d8}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="21.10.0.33144"               # [optional] java agent release (defaults to '21.10.0.33144').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="6b7f3690890dbbc6148699710550333ce31dd19da6f41321baa0d6fc180b18d8"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver21.10.0.33144/conf/controller-info.xml'
