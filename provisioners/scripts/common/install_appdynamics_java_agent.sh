...
appd_java_agent_release="${appd_java_agent_release:-24.4.0.35842}"
appd_java_agent_sha256="${appd_java_agent_sha256:-e7f88f3452e857813531c86fea41fa829a643c5c090fc154d20f9af9bf669cbe}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="24.4.0.35842"               # [optional] java agent release (defaults to '24.4.0.35842').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="e7f88f3452e857813531c86fea41fa829a643c5c090fc154d20f9af9bf669cbe"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver24.4.0.35842/conf/controller-info.xml'
