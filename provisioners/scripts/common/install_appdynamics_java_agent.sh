...
appd_java_agent_release="${appd_java_agent_release:-20.10.0.31173}"
appd_java_agent_sha256="${appd_java_agent_sha256:-5bab2ed2918190a33523434a60a76573391faf587751c41c9b8b434279d96f69}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="20.10.0.31173"              # [optional] java agent release (defaults to '20.10.0.31173').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="5bab2ed2918190a33523434a60a76573391faf587751c41c9b8b434279d96f69"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver20.10.0.31173/conf/controller-info.xml'
