...
appd_java_agent_release="${appd_java_agent_release:-24.6.0.36087}"
appd_java_agent_sha256="${appd_java_agent_sha256:-4efd4d9134b784c1b31130ff810b2b2a18c0459c40c92b3946a8e67285f5206f}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="24.6.0.36087"               # [optional] java agent release (defaults to '24.6.0.36087').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="4efd4d9134b784c1b31130ff810b2b2a18c0459c40c92b3946a8e67285f5206f"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver24.6.0.36087/conf/controller-info.xml'
