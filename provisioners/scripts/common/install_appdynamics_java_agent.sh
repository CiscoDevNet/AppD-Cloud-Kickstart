...
appd_java_agent_release="${appd_java_agent_release:-22.10.0.34344}"
appd_java_agent_sha256="${appd_java_agent_sha256:-e320272038f141e60e76d6a2cca51e244862996b7d1cdfc5f7af7063132c6b19}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="22.10.0.34344"              # [optional] java agent release (defaults to '22.10.0.34344').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="e320272038f141e60e76d6a2cca51e244862996b7d1cdfc5f7af7063132c6b19"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver22.10.0.34344/conf/controller-info.xml'
