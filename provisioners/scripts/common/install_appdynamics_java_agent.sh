...
appd_java_agent_release="${appd_java_agent_release:-23.11.0.35328}"
appd_java_agent_sha256="${appd_java_agent_sha256:-01eeed0bdb017e70d2ca439207e2f8b2a5ea747922eaa0e357d237c37631a5b5}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="23.11.0.35328"              # [optional] java agent release (defaults to '23.11.0.35328').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="01eeed0bdb017e70d2ca439207e2f8b2a5ea747922eaa0e357d237c37631a5b5"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver23.11.0.35328/conf/controller-info.xml'
