...
appd_java_agent_release="${appd_java_agent_release:-21.8.0.32958}"
appd_java_agent_sha256="${appd_java_agent_sha256:-742936533d714e3209fb11d380824041cbeaa2f438713f992970927be77e3266}"
...
Usage:
  ...
  [OPTIONAL] appdynamics java agent install parameters [w/ defaults].
    ...
    [root]# export appd_java_agent_release="21.8.0.32958"               # [optional] java agent release (defaults to '21.8.0.32958').
                                                                        # [optional] java agent sha-256 checksum (defaults to published value).
    [root]# export appd_java_agent_sha256="742936533d714e3209fb11d380824041cbeaa2f438713f992970927be77e3266"
  ...
  [OPTIONAL] appdynamics java agent config parameters [w/ defaults].
    ...
    NOTE: Setting 'appd_java_agent_config' to 'true' allows you to perform the Java Agent configuration
          ...
          configuration file can be found here: '<java_agent_home>/appagent/ver21.8.0.32958/conf/controller-info.xml'
