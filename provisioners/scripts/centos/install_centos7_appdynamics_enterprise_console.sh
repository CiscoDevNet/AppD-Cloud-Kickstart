...
appd_platform_release="${appd_platform_release:-20.6.6.22658}"
appd_platform_sha256="${appd_platform_sha256:-3f339758b8ba5f52b5e32a823f17db9fd7eb6e573e66818c4afb21fd2f4418ba}"
...
Usage:
  ...
  [OPTIONAL] appdynamics platform install parameters [w/ defaults].
    ...
    [root]# export appd_platform_release="20.6.6.22658"                 # [optional] platform release (defaults to '20.6.6.22658').
                                                                        # [optional] platform sha-256 checksum (defaults to published value).
    [root]# export appd_platform_sha256="3f339758b8ba5f52b5e32a823f17db9fd7eb6e573e66818c4afb21fd2f4418ba"
