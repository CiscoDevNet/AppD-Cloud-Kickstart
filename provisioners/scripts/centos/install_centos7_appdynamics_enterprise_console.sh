...
appd_platform_release="${appd_platform_release:-23.11.0.10102}"
appd_platform_sha256="${appd_platform_sha256:-9038befe7226d105cb4866279c95b1fea38b7dbabab1caec02a903116cc908d2}"
...
Usage:
  ...
  [OPTIONAL] appdynamics platform install parameters [w/ defaults].
    ...
    [root]# export appd_platform_release="23.11.0.10102"                # [optional] platform release (defaults to '23.11.0.10102').
                                                                        # [optional] platform sha-256 checksum (defaults to published value).
    [root]# export appd_platform_sha256="9038befe7226d105cb4866279c95b1fea38b7dbabab1caec02a903116cc908d2"
