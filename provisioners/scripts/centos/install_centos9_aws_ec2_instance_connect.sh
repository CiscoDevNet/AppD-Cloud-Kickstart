#!/bin/sh -eux
#---------------------------------------------------------------------------------------------------
# Install EC2 Instance Connect for CentOS 9.
#
...
curl --silent --location https://amazon-ec2-instance-connect-us-west-2.s3.us-west-2.amazonaws.com/latest/linux_amd64/ec2-instance-connect.rpm --output ec2-instance-connect.rpm
...
dnf -y install ec2-instance-connect.rpm ec2-instance-connect-selinux.rpm
