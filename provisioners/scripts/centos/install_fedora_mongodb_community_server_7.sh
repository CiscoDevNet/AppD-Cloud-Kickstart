#!/bin/bash -eux
#---------------------------------------------------------------------------------------------------
# Install MongoDB Community Server 7.0 on Fedora Linux (Cloud Edition).
#
...
user_name="${user_name:-fedora}"                                            # [optional] user name for testing.
user_group="${user_group:-fedora}"                                          # [optional] user login group for testing.
