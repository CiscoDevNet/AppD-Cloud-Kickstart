...
appd_machine_agent_release="${appd_machine_agent_release:-24.1.0.3984}"
appd_machine_agent_sha256="${appd_machine_agent_sha256:-778a53881c26dd570933ea9bdb4461e9ac56e68c3fb0f8e268dd453c9cb084d2}"
...
Usage:
  ...
  [OPTIONAL] appdynamics machine agent install parameters [w/ defaults].
    ...
    [root]# export appd_machine_agent_release="24.1.0.3984"             # [optional] machine agent release (defaults to '24.1.0.3984').
                                                                        # [optional] machine agent sha-256 checksum (defaults to published value).
    [root]# export appd_machine_agent_sha256="778a53881c26dd570933ea9bdb4461e9ac56e68c3fb0f8e268dd453c9cb084d2"
