...
appd_machine_agent_release="${appd_machine_agent_release:-21.2.0.3052}"
appd_machine_agent_sha256="${appd_machine_agent_sha256:-0ac83a580f3dc8d849e6275772db76f788d0e623a5c0b7961e9d4597b0d1e559}"
...
Usage:
  ...
  [OPTIONAL] appdynamics machine agent install parameters [w/ defaults].
    ...
    [root]# export appd_machine_agent_release="21.2.0.3052"             # [optional] machine agent release (defaults to '21.2.0.3052').
                                                                        # [optional] machine agent sha-256 checksum (defaults to published value).
    [root] export appd_machine_agent_sha256="0ac83a580f3dc8d849e6275772db76f788d0e623a5c0b7961e9d4597b0d1e559"
