...
appd_machine_agent_release="${appd_machine_agent_release:-21.3.0.3059}"
appd_machine_agent_sha256="${appd_machine_agent_sha256:-8f3372c06f2b7e5a13c1c70d164674de2df4eeca201f8eb7d1fbc26a559c9fd4}"
...
Usage:
  ...
  [OPTIONAL] appdynamics machine agent install parameters [w/ defaults].
    ...
    [root]# export appd_machine_agent_release="21.3.0.3059"             # [optional] machine agent release (defaults to '21.3.0.3059').
                                                                        # [optional] machine agent sha-256 checksum (defaults to published value).
    [root] export appd_machine_agent_sha256="8f3372c06f2b7e5a13c1c70d164674de2df4eeca201f8eb7d1fbc26a559c9fd4"
