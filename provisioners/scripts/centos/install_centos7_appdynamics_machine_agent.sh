...
appd_machine_agent_release="${appd_machine_agent_release:-21.6.0.3155}"
appd_machine_agent_sha256="${appd_machine_agent_sha256:-06043819d90be38bf2690ebe55b5bd31455c14fc4b58cd7cf3958a60c163fcfb}"
...
Usage:
  ...
  [OPTIONAL] appdynamics machine agent install parameters [w/ defaults].
    ...
    [root]# export appd_machine_agent_release="21.6.0.3155"             # [optional] machine agent release (defaults to '21.6.0.3155').
