...
appd_machine_agent_release="${appd_machine_agent_release:-22.3.0.3296}"
appd_machine_agent_sha256="${appd_machine_agent_sha256:-b89b09db832b3e3a1dbe3ef43f7dbfd349bfd65307af64cd55c90377c07e22da}"
...
Usage:
  ...
  [OPTIONAL] appdynamics machine agent install parameters [w/ defaults].
    ...
    [root]# export appd_machine_agent_release="22.3.0.3296"             # [optional] machine agent release (defaults to '22.3.0.3296').
                                                                        # [optional] machine agent sha-256 checksum (defaults to published value).
    [root]# export appd_machine_agent_sha256="b89b09db832b3e3a1dbe3ef43f7dbfd349bfd65307af64cd55c90377c07e22da"
