...
appd_machine_agent_release="${appd_machine_agent_release:-21.10.0.3188}"
appd_machine_agent_sha256="${appd_machine_agent_sha256:-20e9b4da865f7d0e4c6e96fc6b44346ec114f8735f4034d3cd0d0dcbca3ca0da}"
...
Usage:
  ...
  [OPTIONAL] appdynamics machine agent install parameters [w/ defaults].
    ...
    [root]# export appd_machine_agent_release="21.10.0.3188"            # [optional] machine agent release (defaults to '21.10.0.3188').
                                                                        # [optional] machine agent sha-256 checksum (defaults to published value).
    [root] export appd_machine_agent_sha256="20e9b4da865f7d0e4c6e96fc6b44346ec114f8735f4034d3cd0d0dcbca3ca0da"
