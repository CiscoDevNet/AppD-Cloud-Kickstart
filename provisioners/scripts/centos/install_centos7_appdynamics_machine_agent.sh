...
appd_machine_agent_release="${appd_machine_agent_release:-22.6.0.3386}"
appd_machine_agent_sha256="${appd_machine_agent_sha256:-a3371f1d2e6ebc39308411c2bbc8e138015f91a1481c7ab93eeee09938b22827}"
...
Usage:
  ...
  [OPTIONAL] appdynamics machine agent install parameters [w/ defaults].
    ...
    [root]# export appd_machine_agent_release="22.6.0.3386"             # [optional] machine agent release (defaults to '22.6.0.3386').
                                                                        # [optional] machine agent sha-256 checksum (defaults to published value).
    [root]# export appd_machine_agent_sha256="a3371f1d2e6ebc39308411c2bbc8e138015f91a1481c7ab93eeee09938b22827"
