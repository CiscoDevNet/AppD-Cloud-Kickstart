...
appd_machine_agent_release="${appd_machine_agent_release:-21.11.0.3194}"
appd_machine_agent_sha256="${appd_machine_agent_sha256:-531c47c5ea9cd3154bd4940372a6116525b7aff555822156694afbe0203d19fa}"
...
Usage:
  ...
  [OPTIONAL] appdynamics machine agent install parameters [w/ defaults].
    ...
    [root]# export appd_machine_agent_release="21.11.0.3194"            # [optional] machine agent release (defaults to '21.11.0.3194').
                                                                        # [optional] machine agent sha-256 checksum (defaults to published value).
    [root] export appd_machine_agent_sha256="531c47c5ea9cd3154bd4940372a6116525b7aff555822156694afbe0203d19fa"
