...
-	Amazon AWS CLI 2.14.6 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.14.6](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
2.	Validate installed command-line tools:
    ...
    ```bash
    $ aws --version
    aws-cli/2.14.6 Python/3.11.6 Darwin/23.1.0 source/arm64 prompt/off
    ```
...
1.	Install [AWS CLI 2.14.6](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
2.	Validate installed command-line tool:
    ...
    ```bash
    $ aws --version
    aws-cli/2.14.6 Python/3.11.6 Windows/10 exe/AMD64 prompt/off
    ```
...
-	Ansible 2.9.27
-	AppDynamics Enterprise Console 23.11.0 Build 10102
	-	AppDynamics Controller 23.11.0.1 Build 10089
...
-	Python 3.6.8
	-	Pip3 23.3.1
-	VIM - Vi IMproved 9.0
-	yq 4.40.4 (command-line YAML processor)
...
-	Amazon AWS EC2 Instance Metadata Query Tool (command-line interface)
-	Amazon AWS EKS CLI [eksctl] 0.165.0 (command-line interface)
...
-	Go 1.21.5
-	Gradle 8.5
-	Helm CLI 3.13.2 (Package Manager for Kubernetes)
-	Java SE JDK 8 Update 392 (Amazon Corretto 8)
