...
-	Amazon AWS CLI 2.8.2 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [AWS CLI 2.8.2](https://docs.aws.amazon.com/cli/latest/userguide/install-cliv2-mac.html).  
...
1.	Install [AWS CLI 2.8.2](https://awscli.amazonaws.com/AWSCLIV2.msi) for Windows 64-bit.  
...
-	jq 1.6 (command-line JSON processor)
-	Maven 3.8.6
-	MongoDB Community Server 5.0.13
