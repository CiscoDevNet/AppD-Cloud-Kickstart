...
2.	Install [Packer 1.8.4](https://releases.hashicorp.com/packer/1.8.4/packer_1.8.4_windows_amd64.zip) for Windows 64-bit.  
    Create suggested install folder and extract contents of ZIP file to:  
    `C:\HashiCorp\bin`  

3.	Install [Terraform 1.3.5](https://releases.hashicorp.com/terraform/1.3.5/terraform_1.3.5_windows_amd64.zip) for Windows 64-bit.  
    Create suggested install folder and extract contents of ZIP file to:  
    `C:\HashiCorp\bin`  
