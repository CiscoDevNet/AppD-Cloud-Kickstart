...
1.	Install [Git 2.37.1](https://github.com/git-for-windows/git/releases/download/v2.37.1.windows.1/Git-2.37.1-64-bit.exe) for Windows 64-bit.
...
3.	Install [Terraform 1.2.5](https://releases.hashicorp.com/terraform/1.2.5/terraform_1.2.5_windows_amd64.zip) for Windows 64-bit.  
    Create suggested install folder and extract contents of ZIP file to:  
    `C:\HashiCorp\bin`  
