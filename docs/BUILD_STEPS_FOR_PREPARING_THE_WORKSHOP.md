...
1.	Install the [Homebrew 3.2.3](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    ```bash
...
4.	Install [Terraform 1.0.3](https://www.terraform.io/downloads.html) for macOS 64-bit.  
    ```bash
    $ brew tap hashicorp/tap
...
1.	Install [Git 2.32.0](https://github.com/git-for-windows/git/releases/download/v2.32.0.windows.1/Git-2.32.0-64-bit.exe) for Windows 64-bit.

2.	Install [Packer 1.7.4](https://releases.hashicorp.com/packer/1.7.4/packer_1.7.4_windows_amd64.zip) for Windows 64-bit.  
    Create suggested install folder and extract contents of ZIP file to:  
    `C:\HashiCorp\bin`  

3.	Install [Terraform 1.0.3](https://releases.hashicorp.com/terraform/1.0.3/terraform_1.0.3_windows_amd64.zip) for Windows 64-bit.  
    Create suggested install folder and extract contents of ZIP file to:  
    `C:\HashiCorp\bin`  
