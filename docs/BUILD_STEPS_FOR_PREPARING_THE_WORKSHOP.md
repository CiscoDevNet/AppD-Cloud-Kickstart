...
1.	Install the [Homebrew 4.0.16](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    ```bash
...
3.	Install [Terraform 1.4.6](https://releases.hashicorp.com/terraform/1.4.6/terraform_1.4.6_windows_amd64.zip) for Windows 64-bit.  
    Create suggested install folder and extract contents of ZIP file to:  
    `C:\HashiCorp\bin`  
