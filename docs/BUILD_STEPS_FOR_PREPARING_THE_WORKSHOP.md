...
1.	Install the [Homebrew 4.2.21](https://brew.sh/) package manager for macOS 64-bit. Paste the following into a macOS Terminal prompt:  
    ```bash
    $ /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/master/install.sh)"
    ```

2.	Install [Git 2.45.0](https://git-scm.com/downloads) for macOS 64-bit.  
    ```bash
    $ brew install git
    ```
...
4.	Install [Terraform 1.8.3](https://developer.hashicorp.com/terraform/install) for macOS 64-bit.  
    ```bash
    $ brew tap hashicorp/tap
...
3.	Install [Terraform 1.8.3](https://releases.hashicorp.com/terraform/1.8.3/terraform_1.8.3_windows_amd64.zip) for Windows 64-bit.  
    Create suggested install folder and extract contents of ZIP file to:  
    `C:\HashiCorp\bin`  
