...
1.	Install [Google Cloud SDK 439.0.0](https://cloud.google.com/sdk/docs/quickstart#mac).  
...
1.	Install [Google Cloud SDK 439.0.0](https://dl.google.com/dl/cloudsdk/channels/rapid/GoogleCloudSDKInstaller.exe) for Windows 64-bit.  
