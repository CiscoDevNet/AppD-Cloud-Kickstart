...
-	Google Cloud SDK 435.0.1 (command-line interface)

Perform the following steps to install the needed software:

1.	Install [Google Cloud SDK 435.0.1](https://cloud.google.com/sdk/docs/quickstart#mac).  
...
1.	Install [Google Cloud SDK 435.0.1](https://dl.google.com/dl/cloudsdk/channels/rapid/GoogleCloudSDKInstaller.exe) for Windows 64-bit.  
...
-	Kubernetes CLI [kubectl] 1.24.15 (command-line interface)
